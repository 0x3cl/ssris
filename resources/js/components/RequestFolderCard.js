...
export default defineComponent({
    ...
    template: `
        <Link :href="request.url" class="group block min-w-0 rounded-xl border border-slate-200 bg-white p-5 transition hover:border-[#07559e] hover:shadow-md focus-visible:ring-2 focus-visible:ring-[#07559e]">

...
export default defineComponent({
    ...
    template: `
        <div>
            <div class="fixed bottom-8 right-8 z-30 w-56 transition-all duration-700 ease-out sm:w-64" :class="visible ? 'translate-y-0 opacity-100' : 'pointer-events-none translate-y-10 opacity-0'">

...
export default defineComponent({
    ...
    props: {
        addHref: { type: String, required: true },
    ...
    template: `
        <div class="flex flex-wrap items-end justify-between gap-4">
            ...
            <div class="flex w-full flex-col gap-3 sm:w-auto sm:flex-row">
                ...
                <a :href="addHref" class="inline-flex items-center justify-center gap-2 rounded-lg bg-[#00aeef] px-4 py-2.5 text-sm font-bold text-white transition hover:bg-[#009bd8]"><i class="fa-solid fa-plus" aria-hidden="true"></i>{{ addLabel }}</a>
            </div>
        </div>
    `,
});

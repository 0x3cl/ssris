...
const serviceIllustrations = {
    'rdd-services': '/assets/undraw/researching.svg',
    'tsd-lab-services': '/assets/undraw/science.svg',
    'tsd-icyt-processing-services': '/assets/undraw/data-processing.svg',
    'tips-training-services': '/assets/undraw/teaching.svg',
    'tips-plant-tour-services': '/assets/undraw/watering-plants.svg',
    'picts-library-registration': '/assets/undraw/bookshelves.svg',
};
...
export default defineComponent({
    ...
    setup(props) {
        ...
        const showSubmissionSuccessModal = ref(Boolean(usePage().props.flash?.success));
            ...
            <section class="mx-auto w-full max-w-6xl">
                ...
                <section v-else class="mt-6 rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200 sm:p-8">
                    ...
                    <form class="mt-8 space-y-8" @submit.prevent="openTermsModal">
                        ...
                        <div class="flex justify-between gap-3 border-t border-slate-100 pt-7"><button type="button" class="inline-flex items-center gap-2 rounded-xl border border-slate-300 px-5 py-3 text-sm font-bold uppercase tracking-wide text-[#07559e] transition hover:border-[#07559e] hover:bg-sky-50" @click="currentStep = 3"><i class="fa-solid fa-arrow-left" aria-hidden="true"></i>Go back</button><button type="submit" class="inline-flex items-center gap-2 rounded-xl bg-[#00aeef] px-5 py-3 text-sm font-bold uppercase tracking-wide text-white transition hover:bg-[#008dcc]">Submit appointment request<i class="fa-solid fa-arrow-right" aria-hidden="true"></i></button></div>
                    </form>
                </section>
                </div>
            </section>

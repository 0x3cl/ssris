...
export default defineComponent({
    components: { Head, AdminShell, Link },
    ...
    template: `
        ...
        <AdminShell active="clients" title="Service request">
            <section class="w-full border border-slate-200 bg-white p-5 sm:p-7">
                <Link :href="'/admin/clients/service-requests?client_id=' + client.id" class="text-sm font-semibold text-[#07559e]">← Back to client requests</Link>

...
export default defineComponent({
    ...
    components: { AdminShell, DeleteConfirmationModal, Head },
        ...
        <AdminShell active="feedback-builder" title="Feedback Builder">
            <section class="border border-slate-200 bg-white p-5 shadow-sm sm:p-7">
                <div class="flex flex-wrap items-start justify-between gap-4">
                    ...
                    <div class="flex flex-wrap gap-3"><a href="/admin/feedback-builder/ratings" class="inline-flex items-center justify-center gap-2 rounded-lg border border-slate-300 px-4 py-2.5 text-sm font-bold text-slate-700 transition hover:border-[#07559e] hover:text-[#07559e]"><i class="fa-solid fa-star-half-stroke" aria-hidden="true"></i>Rating Scales</a><a href="/admin/feedback-builder/questions" class="inline-flex items-center justify-center gap-2 rounded-lg border border-slate-300 px-4 py-2.5 text-sm font-bold text-slate-700 transition hover:border-[#07559e] hover:text-[#07559e]"><i class="fa-solid fa-circle-question" aria-hidden="true"></i>Questions</a><a href="/admin/feedback-builder/visualize" target="_blank" rel="noopener" class="inline-flex items-center justify-center gap-2 rounded-lg border border-[#07559e] px-4 py-2.5 text-sm font-bold text-[#07559e] transition hover:bg-sky-50"><i class="fa-solid fa-eye" aria-hidden="true"></i>Visualize</a><a href="/admin/feedback-builder/create" class="inline-flex items-center justify-center gap-2 rounded-lg bg-[#00aeef] px-4 py-2.5 text-sm font-bold text-white transition hover:bg-[#009bd8]"><i class="fa-solid fa-plus" aria-hidden="true"></i>Add dimension</a></div>
                </div>

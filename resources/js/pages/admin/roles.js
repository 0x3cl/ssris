...
export default defineComponent({
    name: 'AdminRoles',
    components: { AdminIndexControls, AdminPagination, AdminShell, DeleteConfirmationModal, Head, Link },

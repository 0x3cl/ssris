        ...
        <AdminShell active="feedback-builder" :title="isEditing ? 'Edit question' : 'Add question'">
            <section class="w-full border border-slate-200 bg-white p-5 shadow-sm sm:p-7">
                <div class="flex flex-wrap items-start justify-between gap-4 border-b border-slate-200 pb-5">
                    ...
                    <Link href="/admin/feedback-builder/questions" class="inline-flex items-center gap-2 rounded-lg border border-slate-300 px-4 py-2 text-sm font-bold text-slate-700 hover:border-[#07559e] hover:text-[#07559e]">
                ...
                <form class="mt-7" @submit.prevent="save">
                    ...
                    <div class="mt-7 flex justify-end gap-3 border-t border-slate-200 pt-5">
                        <Link href="/admin/feedback-builder/questions" class="rounded-lg border border-slate-300 px-5 py-3 text-sm font-bold text-slate-700 hover:bg-slate-50">Cancel</Link>

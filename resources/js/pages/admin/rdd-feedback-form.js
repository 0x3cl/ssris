...
export default defineComponent({
    ...
    props: {
        ...
        rddRequest: { type: Object, required: true },
    ...
    setup(props) {
        ...
        const generateLink = () => {
            ...
            router.post(`/admin/requests/${props.serviceRequest.id}/rdd-request/feedback/generate-link`, {}, {
                preserveScroll: true,
                onFinish: () => {
                ...
                <div class="flex flex-wrap items-start justify-between gap-4">
                    <div>
                        ...
                        <div class="mt-1 flex flex-wrap items-center gap-3">
                            <h2 class="text-2xl font-bold text-slate-900">Service request #{{ serviceRequest.id }} &middot; {{ rddRequest.reference_no }}</h2>
                    ...
                    <div class="mt-7 w-full">
                        ...
                        <dl class="mt-5 grid gap-5 sm:grid-cols-2">
                            <div>
                                ...
                                <dd class="mt-1 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-slate-700">{{ rddRequest.op_no }}</dd><dd class="mt-2"><AttachmentCard :href="rddRequest.op_attachment_url" name="OP attachment" /></dd>
                            </div>
                            <div>
                                <dt class="text-xs font-bold uppercase tracking-wide text-slate-400">OR number</dt>
                                <dd class="mt-1 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-slate-700">{{ rddRequest.or_no }}</dd><dd class="mt-2"><AttachmentCard :href="rddRequest.or_attachment_url" name="OR attachment" /></dd>
                            </div>
                        </dl>
                    </div>

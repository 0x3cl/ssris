    ...
    template: `
        ...
        <main class="min-h-screen bg-white px-4 py-8 sm:px-6 sm:py-12">
            ...
            <FeedbackModal
                ...
                message="Your service request has been received. Our team will review it and send the next steps to your email address."
